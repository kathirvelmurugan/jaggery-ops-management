-- =============================================================================
-- MIGRATION SCRIPT: Old Schema to Enhanced Schema
-- WARNING: This will delete all existing data!
-- =============================================================================

-- Step 1: Drop all existing tables and dependencies
DROP TABLE IF EXISTS dispatch_confirmations CASCADE;
...
DROP TABLE IF EXISTS lot_products CASCADE;
...
-- Step 2: Drop and recreate UUID extension
DROP EXTENSION IF EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Step 3: Now create the enhanced schema

-- =============================================================================
-- 1. MASTER DATA TABLES (ENHANCED)
-- =============================================================================
...
-- =============================================================================
-- 2. TRANSACTIONAL DATA MODELS (NORMALIZED FOR MULTI-PRODUCT LOTS)
-- =============================================================================
...
-- Insert product categories (as specified in requirements)
...
-- Insert farmers (enhanced with auction and billing names)
...
-- Insert customers (enhanced with bag marking)
...
SELECT 
  'Products: ' || COUNT(*) as verification FROM products
UNION ALL
SELECT 
  'Farmers: ' || COUNT(*) FROM farmers
UNION ALL  
SELECT 
...
-- Show the new normalized structure
SELECT 'Enhanced normalized schema is ready for multi-product lot operations!' as message;